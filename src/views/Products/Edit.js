                    ...
                    <div>
                      <form>
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <FormGroup>
                              <ControlLabel>Đơn vị</ControlLabel><span className="star">*</span>
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <FormGroup>
                              <ControlLabel>Đơn giá</ControlLabel><span className="star">*</span>
                              <FormControl className="validate-error" placeholder="Đơn giá" maxLength="20" type="text" name="price" value={product.price} onChange={this.handleChange}/>
                            </FormGroup>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-md-12">
                            <FormGroup>
                              ...
                              <FormControl className="validate-error" placeholder="Mô tả" maxLength="250" type="text" name="description" value={product.description} onChange={this.handleChange} />
                            </FormGroup>
                          </div>
                        </div>
                        <div className="row">
...
export default connect(mapStateToProps, mapDispatchToProps, null, { withRef: true })(EditProduct);
